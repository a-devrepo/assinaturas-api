...
import br.com.cotiinformatica.api_assinaturas.domain.exceptions.RegistroNaoEncontradoException;
...
public class ClienteService {
    ...
    public ClienteResponse alterarCliente(Integer id, ClienteRequest request) throws Exception {
        ...
        if (registro.isEmpty())
            throw new RegistroNaoEncontradoException("Cliente não encontrado para o id informado: " + id);
